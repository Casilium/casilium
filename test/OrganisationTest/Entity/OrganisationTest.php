...
class OrganisationTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(\Organisation\Entity\OrganisationInterface::class, $this->organisation);
    }
    ...
    public function testGetDomainsReturnsCollection(): void
    {
        ...
        $this->assertInstanceOf(\Doctrine\Common\Collections\Collection::class, $domains);
