...
class SlaTargetTest extends TestCase
{
    ...
    public function testGetTimeInSecondsCalculationAccuracy(): void
    {
        ...
        $this->assertEquals(3660, $this->slaTarget->getTimeInSeconds('01:01')); // Fixed: 1 hour + 1 minute = 3660 seconds
        $this->assertEquals(362340, $this->slaTarget->getTimeInSeconds('99:99')); // Actual calculation: 99*3600 + 99*60 = 356400 + 5940 = 362340
    }
}